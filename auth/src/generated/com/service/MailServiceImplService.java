 ...
 * 
 */
@WebServiceClient(name = "MailServiceImplService", targetNamespace = "http://service.com/", wsdlLocation = "http://localhost:9999/ws/mailSender?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MAILSERVICEIMPLSERVICE_QNAME = new QName("http://service.com/", "MailServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/ws/mailSender?wsdl");
    ...
    public MailService getMailServiceImplPort() {
        return super.getPort(new QName("http://service.com/", "MailServiceImplPort"), MailService.class);
    }
    ...
    public MailService getMailServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.com/", "MailServiceImplPort"), MailService.class, features);
    }
